...
public class TestCaseUltimaSesion {
    ...
    public void crearCliente(){
        crearClientePage.crearCliente("Pedro Aguilar2", "12345", "123456789","recoleta 123");
        // Validar que se haya creado el cliente correctamente
        Assert.assertTrue(registroPage.findClientByName("Pedro Aguilar2"));
    }
    @AfterSuite
